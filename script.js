...
function setScoreText(mood){
    ...
    if(mood=='vscomputer'){
        playerOneScore.textContent = `Your Score : 0`;
        playerTwoScore.textContent = 'Computer Score: 0';
    }
    if(mood =='twoplayer'){
        playerOneScore.textContent = `${player1_name} Score : 0`;
        playerTwoScore.textContent = `${player2_name} Score : 0`;
    }
}
...
function wins(player){
    ...
    if(player == 'X'){
        Xscore+=1;
        // console.log(Xscore);
        playerOneScore.textContent = `${player1_name} Score : ${Xscore}`;
    }
    else if(player == 'O'){
        Oscore+=1;
        playerTwoScore.textContent = `${player2_name} Score : ${Oscore}`;
    }
}
...
// let 
// function comeditNames() { 
//     player1_name = prompt("Change Player1 name");

//     console.log( player1_name)

//     if(player1_name == null ||player1_name === "" ){
